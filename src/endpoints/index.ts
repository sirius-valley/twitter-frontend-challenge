...
//Comment
export const commentMe_endpoint: string = "/comments/me"
export const postComment_endpoint: string = "/comments"
...
export const getCommentsByCommentId_param_endpoint = (commentId: string) => `/comment/by_post/${commentId}`
